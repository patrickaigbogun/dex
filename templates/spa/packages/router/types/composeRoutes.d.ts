...
type ComposeResult<App, Fns extends RouteFn<any, any>[]> = Fns extends [
    infer First,
    ...infer Rest
] ? First extends RouteFn<App, infer Next> ? Rest extends RouteFn<any, any>[] ? ComposeResult<Next, Rest> : Next : App : App;
/**
 ...
 * ```
 */
export declare function composeRoutes<App, Fns extends RouteFn<any, any>[]>(app: App, routes: [...Fns]): ComposeResult<App, Fns>;
export {};
